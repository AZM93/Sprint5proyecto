...
archivo_csv = os.path.join(os.path.expanduser("~"), "Desktop", "DataScientist", "GitHub", "Sprint5proyecto", "vehicles_us.csv")
car_data = pd.read_csv(archivo_csv)# leer los datos
